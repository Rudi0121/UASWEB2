...
<body>
    <div style="background-image :url('covid7.png')">
        <div class="container">
            <div>
                <div class=" text-center">
                    <h3 style="font-size:23">
                        </style>Rekapitulasi Penerimaan Bantuan Sosial COVID-19</h3>
                    <h3 style="font-size:18">
                        </style>Sampai dengan 18 Juli 2020, Pukul 20.00 WIB</h3><br>
                </div>
                <div class="text-right mt-3 mb-3">
                    <a href="tambah_alokasi.php" class="btn btn-dark">Add</a>
                </div>
                <table class="table">
                    <thead>
                        <tr>
           ...
           ?>
                ...
                <div class="text-left mt-3 mb-3">
                    <a href="generate_pdf.php" class="btn btn-dark">Download PDF</a>
                </div>
            </div>
        </div>
    </div>
